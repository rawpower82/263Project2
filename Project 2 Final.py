...
# Output Begins Here
print("Welcome to Vehicle Cost Comparing!")
...
while menu_option != 0:
    ...
    # Add a Vehicle to the Inventory
        ...
        while valid == False:   # Confirm that input is entered as a number
            try:
                ...
                print ("\tError. Please enter the year using an integer.")
                year = input("\tWhat is the year of the car?: ")
    ...
    # Compare Costs, View Plots, Etc.
        ...
        for i in range(0,len(inventory)):
            ...
            maint_per_mile = (3906.765451+inventory[i].getPrice()*0.042379218)/(5*15000) # maintenance per year / miles per year = maintenance per mile
            print ("\t\tYou will spend about $" + str("{0:.2f}".format(maint_per_mile * miles_per_year)) + " per year on maintenance & repairs." )
