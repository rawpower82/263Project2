...
while menu_option != 0:
    ...
    # Compare Costs, View Plots, Etc.
        ...
        print ("\n\nCompare Costs:\n")
        gas_price = float(input("\tWhat is the expected average cost of gas per gallon over the next five years?: $"))
        miles_per_year = float(input("\tHow many miles are you expected to drive each year on average ?: "))
